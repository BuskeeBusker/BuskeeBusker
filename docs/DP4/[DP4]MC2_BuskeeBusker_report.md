...
Task 1
High: It seems that the website has too much information in the main page which is schedule page. (P1, P2, P3)
Medium: The logo on the top-left is not clickable. It should link to the main page of the website. (P1)
Low: There is no button for getting default “recommended/hot now tab” to get back. (P2)
Low: Only hot now tab can be selected now. Recommended tab is not working. (P2)
Task 2
High: It’s hard to know about how to find buskers’ page and follow them to subscribe to their posts. (P2, P3)
Low: It is not possible to unfollow the busker. (P1)
Low: It might be better if I can write comments to the busker’s post.(P3)
Task 3
High: Radio buttons make it hard to find target entry of the category. Also it might be too verbose if there are much entries for each of the categories. (P1, P2, P3)
Medium: There should be more specific selections for place category. (P1, P3)
Medium: Some buskers might not have recorded videos, so it might be useless for them. (P3)
Low: It’s hard to notice about the contents of the videos. Titles or descriptions about them are needed. (P3)
...
Make main page that has only introductory information of the website.
If a user clicks the logo on the top-left, the website should move to the main page.
Add close button to overlapped information like map or busker preview. If a user clicks it, then the default tab will occur.
Enable recommend tab to work properly.
Add tutorial or another indicator to help learning the process of following buskers.
Add unfollow button to the busker page.
Add commenting functions to the busker’s post.
Change radio buttons to drop-down list. It will help a user to view entries at a glance.
Add more locations to the category and add it all to the drop-down list.
 Some might not have videos, but we think that the video is the best medium to show the impression of the buskers. So, for the buskers who does not have any video contents, we will replace the video tab of them with other contents
Add title text boxes to videos.
5. Paper vs Digital
...
1) “Likes” Feedback
Well focused on busker’s schedule, that user can easilty find busker information based on his/her information. 
Design of the website, especially the aesthetics
