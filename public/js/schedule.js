...
function displayNoResult(){
	var feild=document.getElementById("noresult");
	feild.innerHTML='<div style="text-align:center" id="Noresultnoti"> There is NO busking schedule on selected date and location. </div>'
}
